    ...
    <SafeAreaView style={{...GlobalStyle.Container}}>
      ...
      <View>
        <View style={{marginBottom: 8}}>
          <Text style={{...GlobalStyle.heading}}>Verify Reset Code</Text>
          <Text
            style={{
              ...styles.textStyle,
              letterSpacing: 1,
        ...
        <View
          style={{
            marginVertical: Window.fixPadding * 2.5,
            marginHorizontal: Window.fixPadding * 1.5,
          }}>
          <CodeField
        ...
        <View style={{alignItems: 'center'}}>
          <Text
            ...
            Code expires in :
            <Text style={{color: '#597766', fontFamily: Font.Gilroy_Medium}}>
              {' '}
              00 : 55
            </Text>
          </Text>
            ...
            <TouchableOpacity>
              <Text
                style={{
                  color: '#597766',
                  fontFamily: Font.Gilroy_Medium,
                  marginLeft: Window.fixPadding / 2,
                }}>
                Resend Code
              </Text>
            </TouchableOpacity>
